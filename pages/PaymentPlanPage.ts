...
export class PaymentPlanPage extends BasePage {
  ...
  public readonly highlightedUpfrontSection: Locator = this.page.locator(
    "//*[@ng-reflect-ng-class = 'plan-selected' and @aria-controls = 'cdk-accordion-child-0']"
  );
  public readonly highlightedInstallmentsSection: Locator = this.page.locator(
  ...
  public readonly UpfrontText: Locator = this.page.locator("//span[@class='payment-type' and contains(text(),'Upfront')]");
  public readonly InstallmentsText: Locator = this.page.locator("//span[@class='payment-type' and contains(text(),'5 Installments')]");
  public readonly upfrontPayOnceText: Locator = this.page.locator("//\*[@class='discount-price']//span[contains(., ' pay once')]");
